...
Route::middleware(['auth:admin'])->group(function () {
    ...
    Route::post('admin/get-weekly-statistics', [StatisticsController::class, 'get_weekly_statistics'])->name('admin.get-statistics');
    Route::post('admin/filter-yearly-statistics', [StatisticsController::class, 'filter_yearly_statistics'])->name('admin.get-statistics');
    Route::post('admin/filter-weekly-statistics', [StatisticsController::class, 'filter_weekly_statistics'])->name('admin.get-statistics');
    //New Statistic Route
