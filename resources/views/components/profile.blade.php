        ...
        <div class="bg-white shadow-lg rounded-lg p-6 mb-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex flex-col gap-2">
                    <a href="{{ route('contact') }}" class="bg-blue-600 text-white px-3 py-1.5 rounded-md hover:bg-blue-700 transition duration-300 text-sm flex items-center shadow-sm">
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button class="bg-gray-500 text-white px-3 py-1.5 rounded-md hover:bg-gray-600 transition duration-300 text-sm flex items-center shadow-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
