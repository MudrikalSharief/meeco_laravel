<!DOCTYPE html>
    ...
    <body class="h-screen w-full">
        ...
        {{-- Upper Navigation --}}
        <div id="upper_nav" class="fixed pl-64 pr-3 bg-gray-100 h-12 w-full flex items-center justify-between md:justify-end">
        ...
        <nav class="sidebar w-64 fixed h-full">
            <div class="logo_holder flex-col justify-between items-center w-full">
                <div id="sidebar-logo" class="logo_holder flex justify-start items-center gap-6 w-full pb-6">
            ...
            <ul class="menu">
                <li>
                    <a href="{{route('admin_dashboard')}}" class="menu-item active">
                ...
                <li>
                    <a href="{{ route('admin.subscription') }}" class="menu-item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ route('admin.account') }}" class="menu-item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ route('admin.support') }}" class="menu-item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ route('admin.logs') }}" class="menu-item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
