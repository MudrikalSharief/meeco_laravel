...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/admin_transactions.js'])
...
<body class="h-screen w-full">
    ...
    <nav class="sidebar w-64 fixed h-full">
        ...
        <ul class="menu">
            ...
            <li>
                <a href="{{ route('admin.subscription') }}" class="menu-item {{ request()->routeIs('admin.subscription') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
