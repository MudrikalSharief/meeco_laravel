        ...
        document.addEventListener('DOMContentLoaded', function(){
            ...
            viewToggleBtn.addEventListener('click', function() {
                ...
                if (isGroupedView) {
                    ...
                    // Load quizzes grouped by subject
            ...
            function loadQuizzesBySubject() {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        if (data.quizzesBySubject.length === 0) {
                            subjectsContainer.innerHTML = '<div class="text-center py-4">No quizzes available</div>';
                            return;
                        }
                        
                        data.quizzesBySubject.forEach((item, index) => {
                            ...
                            subjectDiv.innerHTML = `
                                ...
                                <div class="text-sm opacity-80">${item.questions.length} ${item.questions.length === 1 ? 'quiz' : 'quizzes'}</div>
                            `;
                            ...
                            subjectGroupDiv.appendChild(quizzesContainer);
                        ...
                        console.error('Failed to load quizzes by subject');
                    }
                })
                .catch(error => {
