<x-layout>
    <div class="flex justify-center items-start min-h-screen bg-gray-100 pt-16">
        <div class="bg-white shadow-md rounded-lg p-6 w-96 text-center">
            ...
            <p class="mb-2"><strong>Promo:</strong> {{ $promo->name }}</p>
            <p class="mb-2"><strong>Amount Due:</strong> PHP {{ $promo->price }}</p>
            <p class="mb-2"><strong>Duration:</strong> {{ $promo->duration }} days</p>
            <p class="mb-4"><strong>Perks:</strong> {{ $promo->perks }}</p>
