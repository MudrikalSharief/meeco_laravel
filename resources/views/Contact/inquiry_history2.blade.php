    ...
    <div class="bg-white rounded-md p-6 w-full max-w-md">
        ...
        <form id="replyForm" action="{{ route('submitReply', ['ticket_reference' => $inquiry->ticket_reference]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="file" id="reply_user_upload" name="reply_user_upload[]" multiple accept=".png, .jpg, .jpeg, .svg" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
            </div>
            <div class="flex justify-end gap-3">
