...
<body class="bg-gray-100 px-3 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md max-w-sm w-full">
        ...
        <form action="{{ route('admin.register') }}" class="space-y-4" method="POST">
            @csrf
        ...
        <p class="text-xs mt-2">Already Have an Account? <a class="text-blue-500" href="{{ route('admin.login')}}">Log in</a>.</p> 
      </div>
